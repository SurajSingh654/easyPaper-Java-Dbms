...
<title>Insert title here</title>
 ...
 <!-- Font Awesome link -->
    <script
      src="https://kit.fontawesome.com/7780cccd9d.js"
...
<body>
    <div class="navigation">
      ...
      <nav class="navigation__nav">
        <ul class="navigation__list">
          ...
          <li class="navigation__item">
            <a href="#popup" class="navigation__link">SIGN IN</a>
          </li>
          <li class="navigation__item">
            <a href="#popup1" class="navigation__link">SIGN UP</a>
          </li>
        </ul>
      </nav>
    </div>
    <header class="header">
      ...
      <div class="MotivationalTagContainer">
        <h3 class="MotivationalTag">
          &ldquo; Education is not the amount of information that is put into
          your brain and runs riot there, undigested, all your life... &rdquo;
        </h3>
      </div>
    </header>
    <main>
      <section class="teacher-about">
        <div class="text-center u-margin-bottom-large">
          <h4 class="teacher-about__heading-sub">
            Always Respect Our Teachers
          </h4>
        </div>
        <div class="row">
          <div class="col-1-of-2">
            <p class="teacher-about__sentence">
              &ldquo; One child, one teacher, one book, one pen can change the
              world! &rdquo;
            </p>
          </div>
          <div class="col-1-of-2">
            <div class="composition">
              <img
                src="images/abdul-kalam-image.jpg"
                alt="Photo 1"
                class="composition__photo composition__photo--p1"
              /><img
                src="images/albert-einstein-image.jpg"
                alt="Photo 2"
                class="composition__photo composition__photo--p2"
              /><img
                src="images/chanyak-image.jpg"
                alt="Photo 3"
          ...
          <fieldset class="sign1-up-form__fieldset">
            ...
            <div class="row-signup-form">
              <div class="signup-col-1-of-2">
                <label for="fname" class="signup-label">First name</label>
                <input
                  type="text"
                  id="fname"
                  name="fname"
              ...
              <div class="signup-col-1-of-2">
                <label for="lname" class="signup-label">Last name</label>
                <input
                  type="text"
                  id="lname"
                  name="lname"
            ...
            <div class="row-signup-form">
              ...
              <div class="signup-col-1-of-2">
                ...
                <input type="text" id="text" name="text" class="signup-input" />
              </div>
            </div>
            <div class="row-signup-form">
              <div class="signup-col-1-of-2">
            ...
            <a href="#popup" class="signup-submit-btn-container"
              ><h6 class="signup-submit-btn">Submit</h6></a
            >
          </fieldset>
        </form>
      </div>
